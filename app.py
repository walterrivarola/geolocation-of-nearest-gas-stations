...
if app_mode == 'Run app':
    ...
    c1,c2,c3,c4,c5 = st.columns((1,6,6,6,1)) #El espacio que va a tener cada columna

    choose_city = c2.selectbox("Choose City:", cities)

    central_location = c2.text_input('Central Location', 'CC Multiplaza Bogota')
    ...
    if len(central_location) !=0:
        ...
        gdf_stores_results = GeoDataFrame(results, geometry=points_from_xy(results.LNG, results.LAT))
    ...
    col1.markdown('* [**LinkedIn**](https://www.linkedin.com/in/walterrivarola/)')
    col1.markdown('* [**GitHub**](https://github.com/walterrivarola)')
    image2 = Image.open('IMG_20230101_205102.jpg')
